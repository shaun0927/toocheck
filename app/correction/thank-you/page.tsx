  ...
  return (
    <main className="mx-auto max-w-xl px-6 py-16">
      <div className="relative hud-panel p-8 text-center">
        ...
        <HudLabel tone="cyan" className="!flex !justify-center">RECEIPT // INTAKE</HudLabel>
        {id ? (
          <div className="mt-5">
            <LimeStamp rotate={-3}>정정 요청 접수 // {id}</LimeStamp>
          </div>
        ) : null}
        ...
        <div className="mono mono-10 mt-8 flex flex-col items-center gap-2 text-dim">
          ...
          <a href={`mailto:${SITE.contactEmail}`} className="hover:text-cyan">
            운영자에게 추가 문의: <span className="normal-case tracking-normal" style={{ letterSpacing: 0 }}>{SITE.contactEmail}</span>
          </a>
        </div>
      </div>
    </main>
